...
{
    [Flags]
    public enum OldAchievements : long
    {
        ...
        [Display(Name = "Zombie Fodder"), Description("Be the Zombie that is sent to attempt to convert the zoombies Hunter")]
        zoombiesFodder = 17592186044416,
        ...
        Wuffiezoombies = 18014398509481984,
    ...
    {
        public static string GetDescription(this OldAchievements value)
        {
        ...
        public static string GetName(this OldAchievements value)
        {
        ...
        public static IEnumerable<OldAchievements> GetUniqueFlags(this Enum flags)
        {
            ulong flag = 1;
            foreach (var value in Enum.GetValues(flags.GetType()).Cast<OldAchievements>())
            {
