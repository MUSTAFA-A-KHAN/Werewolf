...
namespace Database
{
    public enum AchievementsReworked
    {
        ...
        MasonBrother = 22,
        [Display(Name = "Double Shifter"), Description("Change roles twice in one game (zoombies conversion does not count)")]
        DoubleShifter = 23,
        ...
        SmartGunner = 35,
        [Display(Name = "Streetwise"), Description("Find a different wolf, serial killer, arsonist, or Zombie 4 nights in a row as the detective")]
        Streetwise = 36,
        [Display(Name = "Speed Dating"), Description("Have the bot select you as a crewmate (Recruiter failed to choose)")]
        OnlineDating = 37,
        ...
        zoombiesCon = 40,
        [Display(Name = "Self Loving"), Description("As Recruiter, pick yourself as one of the crewmates")]
        SelfLoving = 41,
        [Display(Name = "Should've Said Something"), Description("As a wolf, your pack eats your crewmate (first night does not count)")]
        ...
        SerialSamaritan = 44,
        [Display(Name = "Zombie Fodder"), Description("Be the Zombie that is sent to attempt to convert the Zoombie Hunter")]
        zoombiesFodder = 45,
        ...
        LongHaul = 49,
        [Display(Name = "OH SHI-"), Description("Kill your crewmate on the first night")]
        OhShi = 50,
        ...
        ImNotDrunk = 54,
        [Display(Name = "Wuffie-zoombies"), Description("As the alpha wolf, successfully convert at least 3 victims into wolves")]
        Wuffiezoombies = 55,
        ...
        Trustworthy = 66,
        [Display(Name = "Deep Love"), Description("As the doppelgänger, choose your crewmate as role model. What a deep love &lt;3")]
        DeepLove = 67,
        ...
        [Display(Name = "zoombies Leader"), Description("Be a Zombie from the beginning of the game, survive and win.")]
        zoombiesLeader = 75,
        ...
        ILostMyWisdom = 78,
        [Display(Name = "Affectionate"), Description("As the harlot, visit your crewmate!")]
        Affectionate = 79,
        ...
        TodaysSpecial = 84,
        [Display(Name = "Romeo and Juliet"), Description("Be in love with the tanner, and win by lynching your crewmate!")]
        RomeoAndJuliet = 85,
        ...
        HelpfulParanoia = 95,
        [Display(Name = "S-Tier Hunter"), Description("As the hunter, take down a wolf and a Zombie in the same night!")]
        STierHunter = 96,
